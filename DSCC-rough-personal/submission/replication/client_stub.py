...
GRPC_MAX_MSG_SIZE = 64 * 1024 * 1024   # 64 MB
...
class ReplicatedAFSClientStub:
    ...
    def _handle_not_primary(self, details: str) -> bool:
        #Parse a NOT_PRIMARY:<addr> error detail, update primary, and return True so the caller can retry. Returns False if the detail is not that error.
